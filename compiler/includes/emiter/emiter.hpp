...
class LLVMGenerator {
    ...
    llvm::StructType* generateStruct(const std::string& name,
                                     ...
                                     const std::string parentName = "_BI_Object");
    llvm::StructType* generateStruct(const std::string& name,
                                     const std::vector<llvm::Type*>& types,
    ...
    llvm::Function* generateBuildInFunction(std::string name,
                                            std::string returnType,
                                            std::vector<std::string> argTypes,
                                            std::string className);
    llvm::StructType*
    generateBuildInStruct(std::string name, std::vector<std::string> body, const std::string parentName = "_BI_Object");
