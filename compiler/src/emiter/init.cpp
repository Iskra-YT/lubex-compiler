...
llvm::Function* LLVMGenerator::generateBuildInFunction(std::string name,
    ...
    llvm::Function* func =
        llvm::Function::Create(funcType, llvm::GlobalValue::LinkageTypes::ExternalLinkage, name, emiterModule.get());
