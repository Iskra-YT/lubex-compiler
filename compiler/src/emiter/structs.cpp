...
llvm::StructType* LLVMGenerator::generateStruct(const std::string& name,
...
llvm::StructType*
LLVMGenerator::generateBuildInStruct(std::string name, std::vector<std::string> body, const std::string parentName) {
